...
const CONFIG = {
    ...
    valentineName: "Faryal",

    // The title that appears in the browser tab
    // You can use emojis! 💝 💖 💗 💓 💞 💕
    pageTitle: "Will You Be My Valentine? 💝 my sweet gurl, my true love",
    ...
    questions: {
        first: {
            ...
            secretAnswer: "I don't just like it, I love fucking love it! ❤️"           // Secret hover message
        },
        second: {
        ...
        third: {
            text: "Will you be my Valentine on February 14th, 2026? 🌹(and would you let me crack?sorry this is a  error)", // The big question!
            yesBtn: "Yes!",                                             // Text for "Yes" button
            noBtn: "No"                                                 // Text for "No" button
        }
    },
    ...
    celebration: {
        ...
        message: "Now wait to get your gift, a big warm hug and a huge kiss!(on both of your sets of lips😏💦)",
    ...
    music: {
        ...
        musicUrl: "https://drive.google.com/file/d/1QzxCrPZ9z9vOQoMeg92Z9Q3u8Bajx2vZ/view?usp=drivesdk", // Music streaming URL
